...
export default function ExterneInhalte() {
  return (
    <section>
        <h2>Externe Inhalte</h2>
        <h3>Icons</h3>
        <ul>
          <li><a  href="https://icons8.com/icon/13983/youtube">Youtube</a> icon by <a href="https://icons8.com">Icons8</a></li>
          <li><a  href="https://icons8.com/icon/XKFHfgAsrGtk/zuhause">Zuhause</a> icon by <a href="https://icons8.com">Icons8</a></li>
          ...
          <li><a  href="https://icons8.com/icon/rHO15d-sAuKc/spenden">Spenden</a> icon by <a href="https://icons8.com">Icons8</a></li>
        </ul>
          
        
<h3>Bilder by Pixabay</h3>
<ul>
  <li><Link href={'https://pixabay.com/de/service/license-summary/'}>Pixabay Licence</Link></li>
</ul>
